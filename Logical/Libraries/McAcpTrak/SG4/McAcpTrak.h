...
#define _McAcpTrak_VERSION 5.16.9
#endif
...
typedef enum McSSTStatTransUsrCtrlReCtrlEnum
{	mcSSTSTUCRC_INACT = 0,
	mcSSTSTUCRC_ACT = 1
...
{	enum McSSTStatTransUsrCtrlReCtrlEnum UserControlledRecontrol;
} McSSTStatTransType;
