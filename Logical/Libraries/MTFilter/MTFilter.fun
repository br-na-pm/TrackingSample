...
{REDUND_OK} FUNCTION_BLOCK MTFilterBandPass (*Band-pass filter.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
...
{REDUND_OK} FUNCTION_BLOCK MTFilterBandStop (*Band-stop filter.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		Type : MTFilterTypeEnum; (*Filter type. Valid value range: mtBESSEL, mtBUTTERWORTH*)
		Order : USINT; (*Filter order. Valid value range: {1,2}.*)
...
{REDUND_OK} FUNCTION_BLOCK MTFilterBiQuad (*Biquad filter.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_OK} FUNCTION_BLOCK MTFilterHighPass (*High-pass filter.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		Type : MTFilterTypeEnum; (*Filter type. Valid value range: mtBESSEL, mtBUTTERWORTH*)
...
{REDUND_OK} FUNCTION_BLOCK MTFilterLowPass (*Low-pass filter.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		Type : MTFilterTypeEnum; (*Filter type. Valid value range: mtBESSEL, mtBUTTERWORTH*)
		Order : USINT; (*Filter order. Valid value range: {1,2,..,5}.*)
...
{REDUND_CONTEXT} FUNCTION_BLOCK MTFilterMovingAverage (*Moving average filter.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_OK} FUNCTION_BLOCK MTFilterNotch (*Notch filter.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		CenterFrequency : REAL; (*Center frequency. Unit: [Hz]. Valid value range: 0 < CenterFrequency < Sampling frequency/2. Sampling frequency = 1/task cycle time.*)
		Bandwidth : REAL; (*Bandwidth. Unit: [Hz]. Valid value range: 0 < Bandwidth < 2·CenterFrequency.*)
